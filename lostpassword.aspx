			...
			<div class="center-sign">
				...
				<div class="panel panel-sign">
					<div class="panel-title-sign mt-xl text-right">
						<h2 class="title text-uppercase text-weight-bold m-none"><i class="fa fa-user mr-xs"></i> Lost Password</h2>
					</div>
					<div class="panel-body">
						...
						<form id="form1" runat="server">
							...
							<p class="text-center">Don't have an account yet? <a href="signup.aspx">Sign Up!</a></p>
